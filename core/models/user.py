...
class User(db.Model):
    ...
    first_name = Column(String(28), nullable=False)
    last_name = Column(String(28), nullable=False)
    cnic_number = Column(String(28), nullable=False)
    phone_number = Column(String(28), nullable=False)

    def __init__(self, email, first_name, last_name, cnic_number, phone_number):
        self.email = email
